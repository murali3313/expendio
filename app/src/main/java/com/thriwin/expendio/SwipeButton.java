...
public class SwipeButton extends RelativeLayout {
    ...
    float initialPositionOfInnerButton;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            if (backgroundDrawable != null) {
                ...
                background.setBackground(ContextCompat.getDrawable(context, R.drawable.slide_button_rounded));
            }
            ...
            isStartFromLeft = typedArray.getBoolean(R.styleable.SwipeButton_direction_in_left, true);

            int alignParentLeft = isStartFromLeft ? RelativeLayout.ALIGN_PARENT_LEFT : RelativeLayout.ALIGN_PARENT_RIGHT;
            if (initialState == ENABLED) {
                LayoutParams layoutParamsButton = new LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT);

                layoutParamsButton.addRule(alignParentLeft, RelativeLayout.TRUE);
            ...
            if (buttonBackground != null) {
                ...
                swipeButtonInner.setBackground(ContextCompat.getDrawable(context, R.drawable.slide_button));
            }
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        if (initialX == 0) {
                            ...
                            initialPositionOfInnerButton = swipeButtonInner.getX();
                        }
                    ...
                    case MotionEvent.ACTION_UP:
                        if (active) {
                            ...
                            if ((isStartFromLeft ? swipeButtonInner.getX() : initialPositionOfInnerButton) + swipeButtonInner.getWidth() > getWidth() * 0.9) {
    ...
    private void moveButtonBack() {
        final ValueAnimator positionAnimator =
                ValueAnimator.ofFloat(swipeButtonInner.getX(), initialPositionOfInnerButton);
