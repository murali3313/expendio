...
public class AmountProcessor extends Processor {
    ...
    private void removeAllTextBetweenTwoNumerals(StringBuilder expModifiable, String[] allWords, Integer firstOccurenceOfNumber, int index) {
    ...
    private BigDecimal getRupeesAndPaiseFormat(List<BigDecimal> values) {
        String s = "";
        int index = 0;
